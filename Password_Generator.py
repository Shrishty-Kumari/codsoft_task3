...
usern = StringVar()
user_name = Entry(root,textvariable=usern, bd=2, fg="black", font=("ubuntu", 15))
...
acc_btn.bind("<Enter>", on_enter)
acc_btn.bind("<Leave>", on_leave)
...
res_btn.bind("<Enter>", on_enter)
res_btn.bind("<Leave>", on_leave)
